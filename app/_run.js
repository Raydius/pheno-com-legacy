...
angular.module('phenoCom').run(function($rootScope, $window, $location, $anchorScroll, MetaTags) {
    ...
    // init meta tag array into rootscope
  ...
  $(this).parents('.btn-group').find('.dropdown-toggle').html(selText+' <span class="caret"></span>');
    ...
    $(window).resize(function(){
        ...
        // if the user changed to landscape mode
	...
	// events that occur after user scrolls
	$(window).scroll(function() {

        $('.featured-contributors').addClass('show');

        // control whether the "thick" or "thin" version of the top menu shows based on scroll
