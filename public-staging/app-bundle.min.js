...
/***/ function(module, exports, __webpack_require__) {
	...
	_angular2.default.module('phenoCom', [_angularUiRouter2.default, _angularAnimate2.default, 'ngCookies', 'ngMessages', 'sticky']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var templateHome = __webpack_require__(102);
	var templateAbout = __webpack_require__(105);
	var templateWork = __webpack_require__(110);
	var templateWorkAnthem = __webpack_require__(111);
	var templateWorkWilsonX = __webpack_require__(112);
	var templateWorkSLS = __webpack_require__(113);
	var templateWorkXome = __webpack_require__(114);
	var templateWorkThinkThin = __webpack_require__(115);
	var templateWorkMens = __webpack_require__(116);
	var templateWorkSunny = __webpack_require__(117);
	var templateWorkCooper = __webpack_require__(118);
	var templateEntertainment = __webpack_require__(119);
	var templateCulture = __webpack_require__(120);
	var templateContact = __webpack_require__(131);
	var templateJobs = __webpack_require__(134);
	  ...
	  "content": {
	    "home": {
	      ...
	      "contributorsMore": [{
	        ...
	        "jobTitle": "Director of Marketing, thinkThin",
	        "project": "thinkThin Helps<br>Women Shed the Guilt.",
	        "contributorAvatar": __webpack_require__(42)
	      }]
	    },
	    "about": {
	      ...
	      "quoterAvatar": __webpack_require__(43),
	    ...
	    "work": {
	      ...
	      "subcontent": [{
	        ...
	        "type": "image",
	        "image": true,
	        "imageUrl": __webpack_require__(51),
	        ...
	        "type": "image",
	        "image": true,
	        "imageUrl": __webpack_require__(52),
	    ...
	    "wilson-anthem": {
	      ...
	      "client": "Wilson",
	      "clientLogo": __webpack_require__(53),
	      ...
	      "heroThumb": __webpack_require__(54),
	    ...
	    "wilsonX": {
	      ...
	      "quoterAvatar": __webpack_require__(43),
	      "description": "CVU - Phenomenon - Wilson X",
	      "topDescription": ["Every sport has been affected by modern technology, but when it comes to the actual ball used in each sport, it&#8217s typically generations before there is any major advancement. With Wilson X, we really pushed the boundaries of what a basketball could be. It&#8217s the first basketball that connects to your smartphone to help you track makes and misses without any sort of rim attachment.", "<span class='red'>It&#8217s the first basketball that connects to your smartphone to help you track makes and misses without any sort of rim attachment.</span>", "The ball also develops players skills by infusing gaming mechanics into training. There&#8217s audio with crowd noise and sports commentary. There’s a countdown mode to help create clutch shooting for those pressure-filled minutes at the end of a game. And you can even share your progress with friends, family or coaches."],
	      "details": ["Wilson X's idea is simple. It's the first basketball that connects to your smartphone to help you track makes and misses without any sort of rim attachment. It was Wilson's first connected product and was an opportunity for us to show not just how revolutionary the ball was, but how digitally savvy Wilson was becoming. In just a few weeks we named the product. Designed the packaging. Designed the entire app experience. And created the ad campaign around it."],
	      "topcontent": [{
	        "carousel": true,
	        "images": [{
	      ...
	      "detailcontent": [{
	        ...
	        "mainDescription": ["<span class='red'>This was a bold new step for us because suddenly a mobile app was an aspect of what we were selling. The app needed to be as good as the ball itself.</span>"]
	      }, {
	        "video": true,
	        "thumb": __webpack_require__(60),
	        "thumbAlt": "Wilson X - TV Spot - All Day",
	    ...
	    "xome": {
	      ...
	      "quoterAvatar": __webpack_require__(43),
	      "description": "CVU - Phenomenon - Wilson X",
	      "topDescription": ["If you&#8217;ve ever bought or sold a home, you know it’s a complex, fragmented and pretty unfriendly process. With Xome, we wanted to introduce a radically better way to do it.", "<span class='red'>The whole purpose of Xome is to help homebuyers and sellers from start to finish. </span>", "The whole purpose of Xome is to help homebuyers and sellers from start to finish. So we worked with Pheno to build a beautifully intuitive mobile app. In just six weeks we completed the app making it the first truly integrated way to buy and sell a home. With it, you can list a home, search for a home, make and receive offers, move into escrow and close the deal, all from the palm of your hand."],
	      "topcontent": [{
	        "type": "image",
	        "image": true,
	        "imageUrl": __webpack_require__(45),
	      ...
	      "detailcontent": [{
	        "type": "image",
	        "image": true,
	        "imageUrl": __webpack_require__(83),
	        "imageAlt": "Sunny",
	    ...
	    "sunny": {
	      ...
	      "className": "sunny",
	      "client": "Sunny",
	      "clientLogo": __webpack_require__(85),
	      "project": "SLS",
	      "media": "Branding",
	      ...
	      "topcontent": [{
	        ...
	        "imageUrl": __webpack_require__(83),
	        "imageAlt": "Sunny",
	        "mainDescription": ["Strategically, Pheno recognized that there was no loyalty in our industry. People took out their first loan and then had to pay so much back that they took out another loan to pay for that, and so on and so on. Often working with multiple companies in the process, or as they deemed it, &#8222;a circle of debt.", "They designed the packaging for the amenities in the hotel. They created logos and brand books for just about all of our new restaurants and clubs. They even named our espresso bar, Perq."]
	      }],
	      "detailcontent": [{
	        "type": "image",
	        "image": true,
	        ...
	        "thumbTitle": "Click to play video",
	        "vimeo": "159123265",
	        "mainDescription": ["<span class='red'>For years, notoriously shady payday loan company Wonga hid behind endearing puppets. We decided to take them head on with a campaign that basically said don&#8217;t trust puppets, trust a better way of doing it.</span>"]
	      }]
	    },
	    "mens-wearhouse": {
	    ...
	    "think-thin": {
	      ...
	      "client": "Think Thin",
	      "clientLogo": __webpack_require__(88),
	      "project": "Think Thin",
	      "media": "Branding",
	    ...
	    "cooper": {
	      ...
	      "className": "cooper",
	      "client": "Mr.Cooper",
	      "clientLogo": __webpack_require__(89),
	      "project": "Mr.Cooper",
	      "media": "Branding",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "df07c655da40fe6daac6ead2d459de08.png";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "34c29ebcd3be9c10b26fbfcb28c29314.png";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "51685fa9b11606f76f07cd4c180b6e0e.jpg";
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<a href=\"#\" class=\"red\">Read full article &gt;</a></li>");
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.rethrow = function rethrow(err, filename, lineno, str){
	  ...
	  try {
	    str = str || __webpack_require__(104).readFileSync(filename, 'utf8')
	  } catch (ex) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	page = "about"
	pageData = copy.content[page]
	buf.push("<!-- title and body copy--><section class=\"row no-padding about\"><div class=\"top-main col-md-12\"><h2>" + (null == (jade_interp = pageData.blockquote) ? "" : jade_interp) + "</h2><p>" + (null == (jade_interp = pageData.subquote) ? "" : jade_interp) + "</p><cite>");
	...
	{
	buf.push("<span>" + (null == (jade_interp = pageData.quoterName) ? "" : jade_interp) + "</span>");
	}
	if ( pageData.quoterTitle)
	{
	buf.push("<span>" + (null == (jade_interp = pageData.quoterTitle) ? "" : jade_interp) + "</span>");
	}
	buf.push("</div></cite></div><div class=\"col-xs-12 col-md-12 no-padding\"><div class=\"col-xs-12 col-md-5 no-padding\"><figure><img" + (jade.attr("src", __webpack_require__(106), true, true)) + "><figcaption><h3>Phenotype</h3><ul> <span>nonu</span><li>" + (jade.escape(null == (jade_interp = pageData.dictionary.nonu) ? "" : jade_interp)) + "</li><span>verb</span><li>" + (jade.escape(null == (jade_interp = pageData.dictionary.verb) ? "" : jade_interp)) + "</li></ul></figcaption></figure></div><section class=\"col-xs-12 col-md-7\"><article class=\"col-md-12 border-bottom\">");
	...
	buf.push("</article><article class=\"col-md-12\">");
	...
	buf.push("</article></section></div><div class=\"col-xs-12 col-md-12 no-padding archie\"><img" + (jade.attr("src", __webpack_require__(107), true, true)) + "></div><div class=\"col-md-12 no-padding\"><div class=\"col-md-5 no-padding folders\"><img" + (jade.attr("src", __webpack_require__(108), true, true)) + "></div><div class=\"col-md-7\"><article class=\"col-md-12\">");
	...
	buf.push("<img" + (jade.attr("src", __webpack_require__(109), true, true)) + "></article></div></div><div class=\"col-md-12 ac\"><div class=\"col-md-7 no-padding\"><article class=\"col-md-12\">");
	...
	buf.push("</article></div><div sticky offset=\"60\" class=\"col-md-5\"><section class=\"ac-container\">");
	...
	if ( index==0)
	{
	buf.push("<div class=\"ac-list\"><input" + (jade.attr("id", "ac-"+(index), true, true)) + " name=\"accordion-1\" type=\"radio\" checked=\"\"><label" + (jade.attr("for", "ac-"+(index), true, true)) + ">" + (jade.escape(null == (jade_interp = contentItem.label) ? "" : jade_interp)) + "</label><article class=\"ac-small\"><p>" + (jade.escape(null == (jade_interp = contentItem.content) ? "" : jade_interp)) + "</p></article></div>");
	}
	else
	{
	buf.push("<div class=\"ac-list\"><input" + (jade.attr("id", "ac-"+(index), true, true)) + " name=\"accordion-1\" type=\"radio\"><label" + (jade.attr("for", "ac-"+(index), true, true)) + ">" + (jade.escape(null == (jade_interp = contentItem.label) ? "" : jade_interp)) + "</label><article class=\"ac-small\"><p>" + (jade.escape(null == (jade_interp = contentItem.content) ? "" : jade_interp)) + "</p></article></div>");
	}
	    }
	...
	buf.push("</section></div></div></section>");}.call(this,"copy" in locals_for_with?locals_for_with.copy:typeof copy!=="undefined"?copy:undefined,"page" in locals_for_with?locals_for_with.page:typeof page!=="undefined"?page:undefined,"pageData" in locals_for_with?locals_for_with.pageData:typeof pageData!=="undefined"?pageData:undefined,"undefined" in locals_for_with?locals_for_with.undefined: false?undefined:undefined));;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	page = "work"
	pageData = copy.content[page]
	buf.push("<section class=\"row no-padding work\"><article class=\"col-md-12 top-main\"><h2> <blockquote>" + (null == (jade_interp = pageData.blockquote) ? "" : jade_interp) + "</blockquote></h2><cite>");
	if ( pageData.quoterAvatar)
	{
	buf.push("<img" + (jade.attr("src", pageData.quoterAvatar, true, true)) + ">");
	}
	...
	buf.push("<a" + (jade.attr("href", contentItem.readmoreUrl, true, true)) + "><article class=\"col-md-12 cf\"><div class=\"col-xs-12 col-sm-12 col-md-8\">");
	if ( contentItem.image)
	{
	buf.push("<img" + (jade.attr("src", contentItem.imageUrl, true, true)) + (jade.attr("alt", contentItem.imageAlt, true, true)) + ">");
	}
	buf.push("</div><div class=\"col-xs-12 col-sm-12 col-md-4\"><fieldset><legend>" + (jade.escape(null == (jade_interp = contentItem.legend) ? "" : jade_interp)) + "</legend><h3>" + (null == (jade_interp = contentItem.headline) ? "" : jade_interp) + "</h3><cite><span>By Amy Weisenbach</span><span>VP Marketing, Wilson</span></cite><div class=\"line\"></div><p>" + (null == (jade_interp = contentItem.description) ? "" : jade_interp) + "</p><a" + (jade.attr("href", contentItem.readmoreUrl, true, true)) + " class=\"red\">Read More &gt; </a></fieldset></div></article></a>");
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	copy = __webpack_require__(32)
	pageData = copy.content[page]
	buf.push("<section class=\"row no-padding work work-details\"><article class=\"col-md-12 no-padding top-main\"><h2> <blockquote>" + (null == (jade_interp = pageData.blockquote) ? "" : jade_interp) + "</blockquote></h2><cite>");
	if ( pageData.quoterAvatar)
	{
	buf.push("<img" + (jade.attr("src", pageData.quoterAvatar, true, true)) + ">");
	}
	...
	buf.push("</div></cite></article><div class=\"topcontent\"><article class=\"col-xs-12 col-sm-12 col-md-7 top-description\">");
	...
	buf.push("</article><article class=\"col-xs-12 col-sm-12 col-md-4 col-md-offset-1 project-detail\"><aside class=\"col-xs-4 col-md-12\"><input type=\"checkbox\" id=\"toggle-project-detail\" class=\"view-detail\"><label class=\"icon-dot\"> <span>Details</span></label><div class=\"detail-wrapper\"><img" + (jade.attr("src", pageData.clientLogo, true, true)) + " class=\"clientlogo\"><fieldset> <legend>Client</legend><span>" + (jade.escape(null == (jade_interp = pageData.client) ? "" : jade_interp)) + "</span></fieldset><fieldset> <legend>Project</legend><span>" + (jade.escape(null == (jade_interp = pageData.project) ? "" : jade_interp)) + "</span></fieldset><fieldset> <legend>Media</legend><span>" + (jade.escape(null == (jade_interp = pageData.media) ? "" : jade_interp)) + "</span></fieldset></div></aside><aside class=\"col-xs-6 col-md-12\"><fieldset><input type=\"checkbox\" id=\"toggle-share\" class=\"view-detail\"><label class=\"icon-share\"> <span>Share</span></label><ul class=\"social-icons\">");
	// iterate copy.footer.social
	;(function(){
	  var $$obj = copy.footer.social;
	  if ('number' == typeof $$obj.length) {

	    for (var $index = 0, $$l = $$obj.length; $index < $$l; $index++) {
	      var socialItem = $$obj[$index];

	buf.push("<li class=\"social-icon\"><a" + (jade.attr("href", socialItem.url, true, true)) + (jade.attr("title", socialItem.title, true, true)) + " target=\"_blank\"" + (jade.cls([socialItem.className], [true])) + "></a></li>");
	    }

	  } else {
	    var $$l = 0;
	    for (var $index in $$obj) {
	      $$l++;      var socialItem = $$obj[$index];
	...
	buf.push("</ul></fieldset></aside></article><article class=\"col-xs-12 col-sm-12 no-padding\">");
	...
	{
	buf.push("<carousel-component class=\"carousel-component no-padding\">");
	...
	buf.push("<article class=\"col-md-7\"><p>" + (null == (jade_interp = par) ? "" : jade_interp) + "</p></article>");
	    }
	...
	buf.push("<article class=\"col-md-4\"> <a href=\"#\"><img" + (jade.attr("src", contentItem.prjectThumbSrc, true, true)) + "></a><p>" + (null == (jade_interp = contentItem.projectName) ? "" : jade_interp) + "</p><cite> <div class=\"wrapper\"><span>" + (null == (jade_interp = contentItem.writerName) ? "" : jade_interp) + "</span><span>" + (null == (jade_interp = contentItem.writerTitle) ? "" : jade_interp) + "</span></div></cite><a href=\"#\" class=\"red\">Read full article</a></article>");
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	copy = __webpack_require__(32)
	pageData = copy.content[page]
	buf.push("<section class=\"row no-padding work work-details\"><article class=\"col-md-12 no-padding top-main\"><h2> <blockquote>" + (null == (jade_interp = pageData.blockquote) ? "" : jade_interp) + "</blockquote></h2>");
	page = "entertainment"
	buf.push("<cite>");
	if ( pageData.quoterAvatar)
	{
	...
	buf.push("</article><article class=\"col-xs-12 col-sm-12 col-md-4 col-md-offset-1 project-detail\"><aside class=\"col-xs-4 col-md-12\"><input type=\"checkbox\" id=\"toggle-project-detail\" class=\"view-detail\"><label class=\"icon-dot\"> <span>Details</span></label><div class=\"detail-wrapper\"><img" + (jade.attr("src", pageData.clientLogo, true, true)) + " class=\"clientlogo\"><fieldset> <legend>Client</legend><span>" + (jade.escape(null == (jade_interp = pageData.client) ? "" : jade_interp)) + "</span></fieldset><fieldset> <legend>Project</legend><span>" + (jade.escape(null == (jade_interp = pageData.project) ? "" : jade_interp)) + "</span></fieldset><fieldset> <legend>Media</legend><span>" + (jade.escape(null == (jade_interp = pageData.media) ? "" : jade_interp)) + "</span></fieldset></div></aside><aside class=\"col-xs-6 col-md-12\"><fieldset><input type=\"checkbox\" id=\"toggle-share\" class=\"view-detail\"><label class=\"icon-share\"> <span>Share</span></label>");
	page = "entertainment"
...
/***/ function(module, exports, __webpack_require__) {
	...
	page = "culture"
	pageData = copy.content[page]
	buf.push("<!-- title and body copy--><section class=\"row no-padding culture\"> <article class=\"col-md-3 col-md-offset-1 no-padding\"><img" + (jade.attr("src", __webpack_require__(121), true, true)) + "></article><article class=\"col-md-8 top-main\"><h2> <blockquote>" + (null == (jade_interp = pageData.blockquote) ? "" : jade_interp) + "</blockquote></h2><cite>");
	if ( pageData.quoterAvatar)
	{
	buf.push("<img" + (jade.attr("src", pageData.quoterAvatar, true, true)) + ">");
	}
	...
	buf.push("</div></cite></article><article class=\"col-md-12 no-padding\"><img" + (jade.attr("src", __webpack_require__(122), true, true)) + "></article><article class=\"col-md-8 no-padding table\"><div class=\"col-xs-12 col-sm-12 col-md-4 col-md-offset-2 no-padding\"><img" + (jade.attr("src", __webpack_require__(123), true, true)) + "></div><div class=\"col-xs-12 col-sm-12 col-md-6\"><h3><blockquote>I know I'm at Phenomenon when I walk past the La Brea tar pits and see the baby mammoth scream in anguish as its mother is sucked into a bubbling pit of tar. </blockquote></h3><cite><div class=\"wrapper\"><span>Lindsay Phillips</span><span>Men's Wearhouse</span></div></cite></div></article><article class=\"col-md-12 no-padding table\"><div class=\"col-xs-12 col-sm-12 col-md-4 col-md-offset-1\"><h3><blockquote> \nEvery day there's a slew of food trucks in front of their building. \u2028I gain 5 lbs. every time we have meetings there.</blockquote></h3><cite><div class=\"wrapper\"><span>Matt Stringer</span><span>Men's Wearhouse</span></div></cite></div><div class=\"col-xs-12 col-sm-12 col-md-7\"><img" + (jade.attr("src", __webpack_require__(124), true, true)) + "></div></article><article class=\"headshots col-xs-12 col-md-12 no-padding\"> <div class=\"col-xs-4 col-sm-4 col-md-15 no-padding\"> <ul class=\"cf\"><!-- fake image tag to gain height of the container--><img" + (jade.attr("src", __webpack_require__(125), true, true)) + "><li></li><li></li><li></li></ul></div><div class=\"col-xs-4 col-sm-4 col-md-15 no-padding\"> <ul><img" + (jade.attr("src", __webpack_require__(125), true, true)) + "><li></li><li></li><li></li></ul></div><div class=\"col-xs-4 col-sm-4 col-md-15 no-padding\"> <ul><img" + (jade.attr("src", __webpack_require__(125), true, true)) + "><li></li><li></li><li></li></ul></div><div class=\"col-xs-4 col-sm-4 col-md-15 no-padding\"> <ul><img" + (jade.attr("src", __webpack_require__(125), true, true)) + "><li></li><li></li><li></li></ul></div><div class=\"col-xs-4 col-sm-4 col-md-15 no-padding\"> <ul><img" + (jade.attr("src", __webpack_require__(125), true, true)) + "><li></li><li></li><li></li></ul></div></article><article class=\"col-xs-12 col-md-10 no-padding building\"><div class=\"col-xs-12 col-md-7\"><img" + (jade.attr("src", __webpack_require__(126), true, true)) + "><img" + (jade.attr("src", __webpack_require__(127), true, true)) + "></div><div class=\"col-xs-12 col-md-5\"><h3><blockquote>I always know a Pheno because they&#8217;re smiling. Or wearing plaid.</blockquote></h3><cite><div class=\"wrapper\"><span>John</span><span>Building Security</span></div></cite><img" + (jade.attr("src", __webpack_require__(128), true, true)) + "></div></article><article class=\"col-md-12 no-padding\"><div class=\"col-xs-12 col-md-5\"><img" + (jade.attr("src", __webpack_require__(129), true, true)) + "><h3><blockquote>They have quite a collection of<br> ugly mugs. Last time I was there<br> I drank out of Mona Lisa&#8217s head.</blockquote><cite><div class=\"wrapper\"><span>Carl Mackey</span><span>SBE Building Custodian</span></div></cite></h3></div><div class=\"col-xs-12 col-md-7\"><h3><blockquote>They&#8217re generally<br> a\u2028pretty clean bunch.</blockquote><cite><div class=\"wrapper\"><span>Nancy</span><span>Client</span></div></cite></h3><img" + (jade.attr("src", __webpack_require__(130), true, true)) + "></div></article></section>");}.call(this,"copy" in locals_for_with?locals_for_with.copy:typeof copy!=="undefined"?copy:undefined,"page" in locals_for_with?locals_for_with.page:typeof page!=="undefined"?page:undefined,"pageData" in locals_for_with?locals_for_with.pageData:typeof pageData!=="undefined"?pageData:undefined));;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "90c161a1704f697771b41fb79d459cae.png";
...
/***/ function(module, exports, __webpack_require__) {
	...
	page = "contact"
	pageData = copy.content[page]
	buf.push("<section class=\"row no-padding contact\"><article class=\"col-md-12 no-padding top-main\"><h2> <blockquote>" + (null == (jade_interp = pageData.blockquote) ? "" : jade_interp) + "</blockquote></h2><cite>");
	if ( pageData.quoterAvatar)
	{
	buf.push("<img" + (jade.attr("src", pageData.quoterAvatar, true, true)) + ">");
	}
	...
	buf.push("</div></cite></article><div class=\"col-xs-12 col-sm-6 col-md-6\"><figure><img" + (jade.attr("src", __webpack_require__(132), true, true)) + "><figcaption><h3>Los Angeles</h3><ul><li>+1 313 800 800</li><li>5900 Wilshire Blvd, Floor 28, <br>Los Angeles, CA 90036</li></ul></figcaption></figure></div><div class=\"col-xs-12 col-sm-6 col-md-6\"><figure><img" + (jade.attr("src", __webpack_require__(133), true, true)) + "><figcaption><h3>Chicago</h3><ul> <li>+1 323 648 4000</li><li>118 N Peoria Street, Suite 5N <br>Chicago, IL 60607</li></ul></figcaption></figure></div><div class=\"clear\"></div><section class=\"contactbiz clearfix\"><div class=\"col-xs-12 col-sm-4 col-md-4 no-padding\"><h4>Jobs</h4><span>We'd love to hear from you. <br> Tell us some things LinkedIn can't. </span><hr><span> <a href=\"#\">jobs@phenomenon.com</a></span></div><div class=\"col-xs-12 col-sm-4 col-md-4 no-padding\"><h4>New Business</h4><span>Pheno works mostly by referral. <br> Mostly. Not exclusively.</span><hr><span> <a href=\"#\">newbiz@phenomenon.com</a></span></div><div class=\"col-xs-12 col-sm-4 col-md-4 no-padding\"><h4>PR</h4><span> We're generally not the ones talk about<br> ourselves. But you can ask.</span><hr><span> <a href=\"#\">pr@phenomenon.com</a></span></div></section></section><!--include components/contact-form-->");}.call(this,"copy" in locals_for_with?locals_for_with.copy:typeof copy!=="undefined"?copy:undefined,"page" in locals_for_with?locals_for_with.page:typeof page!=="undefined"?page:undefined,"pageData" in locals_for_with?locals_for_with.pageData:typeof pageData!=="undefined"?pageData:undefined));;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "1f8060771234cdfe7d8b2bae1d00c6cf.png";
...
/***/ function(module, exports, __webpack_require__) {
	...
	page = "jobs"
	pageData = copy.content[page]
	buf.push("<!-- title and body copy--><section class=\"row no-padding jobs\"><div class=\"top-main\"><article class=\"col-md-5\"><img" + (jade.attr("src", __webpack_require__(135), true, true)) + "></article><article class=\"col-xs-12 col-sm-12 col-md-7 col-sm-offset-0\"><h2> <blockquote>" + (null == (jade_interp = pageData.blockquote) ? "" : jade_interp) + "</blockquote></h2><cite>");
	if ( pageData.quoterAvatar)
	{
	buf.push("<img" + (jade.attr("src", pageData.quoterAvatar, true, true)) + ">");
	}
	...
	buf.push("</div></cite><ul><span>" + (jade.escape(null == (jade_interp = pageData.positions) ? "" : jade_interp)) + "</span>");
	...
	buf.push("<li> <a" + (jade.attr("href", contentItem.listingUrl, true, true)) + ">" + (jade.escape(null == (jade_interp = contentItem.listingTitle) ? "" : jade_interp)) + "</a></li>");
	    }
	...
	buf.push("</ul></article></div></section>");}.call(this,"copy" in locals_for_with?locals_for_with.copy:typeof copy!=="undefined"?copy:undefined,"page" in locals_for_with?locals_for_with.page:typeof page!=="undefined"?page:undefined,"pageData" in locals_for_with?locals_for_with.pageData:typeof pageData!=="undefined"?pageData:undefined,"undefined" in locals_for_with?locals_for_with.undefined: false?undefined:undefined));;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var videoComponentTemplate = __webpack_require__(139);
	var scrolltopTemplate = __webpack_require__(140);
